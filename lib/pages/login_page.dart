      ...
      body: Container( 
        decoration: BoxDecoration(
          ...
          gradient: RadialGradient(
            ...
            Color.fromARGB(255, 0, 255, 217).withOpacity(0.9),
            Color.fromARGB(255, 25, 14, 62),
            Color.fromARGB(255, 0, 255, 217).withOpacity(0.9),
            ],
          ...
          child: Stack(
            children: <Widget>[
              Container(
                ...
                child: AppTitle(size: 35, color: Colors.white,),
              ), 
              Center(
                child: ClipRect(
                  child: BackdropFilter(
                    ...
                    decoration: BoxDecoration(
                      gradient: RadialGradient(
                        colors: [
                        Color.fromARGB(255, 0, 255, 217).withOpacity(0.9),
                        Color.fromARGB(255, 0, 255, 217).withOpacity(0.1)
                        ],
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          ...
                          child: const Text("CUSTOMER LOGIN", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Color.fromARGB(255, 25, 14, 62))),
                        ),
                        Container(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(onPressed: (){}, 
                            style: const ButtonStyle(
                              ...
                              backgroundColor: MaterialStatePropertyAll(Color.fromARGB(255, 181, 255, 244))
                            ),
                            child: const Text("Login", style: TextStyle(color: Color.fromARGB(166, 13, 106, 92)),),
                          ),
                        ),
                        
                        Container(
                          margin: EdgeInsets.only(left: 40, right: 40, bottom: 20),
                          child: Divider(color: Color.fromARGB(255, 25, 14, 62)),
                        ),
                        TextButton(
                          onPressed: () async {
                            authProvider.handleSignIn().then((isSuccess) {
                              session['isSigned'] = isSuccess.toString();
                              if (isSuccess) {
                          ...
                          style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.resolveWith<Color>(
                              (Set<MaterialState> states) {
                                if (states.contains(MaterialState.pressed)) return Color.fromARGB(255, 221, 57, 79).withOpacity(0.8);
                                return const Color.fromARGB(255, 221, 57, 79);
                              },
                            ),
          ...
          child: Theme(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                fillColor: Color.fromARGB(255, 0, 23, 69),
                filled: true,
                prefixIconColor: Color.fromARGB(255, 0, 255, 217),
                focusColor: Color.fromARGB(255, 0, 255, 217),
              ),
